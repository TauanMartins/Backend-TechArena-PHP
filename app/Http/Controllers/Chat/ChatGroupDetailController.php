...
use TechArena\Funcionalities\UserChat\UserChatDetail;

class ChatGroupDetailController extends Controller
{
    private UserInterface $user;
    private UserChatDetail $userChat;
    private ChatInterface $chat;
    public function __construct(UserInterface $user, ChatInterface $chat, UserChatDetail $userChat)
    {
        $this->user = $user;
        $this->chat = $chat;
    ...
    public function __invoke(Request $request)
    {
        try {
            ...
            $response = $this->userChat->domain($user_chat);
